...
import {
	Box, Button, ButtonGroup, Flex, FormControl, FormErrorMessage, FormLabel, Input, InputGroup, InputLeftElement, Modal, ModalBody,
	ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Spinner, Table, Tbody, Td, Text, Th, Thead, Tr, useToast
} from '@chakra-ui/react';
import { MdSearch } from 'react-icons/md';
import Pagination from "../../../components/pagination/Pagination";
import { ChevronDownIcon, ChevronUpIcon, WarningTwoIcon } from '@chakra-ui/icons';
import FlexBox from '../../../components/FlexBox';
import { createCommission, deleteCommission, getPaginateCommission, updateCommission } from '../../../store/slices/commissions-slice';
					...
					return (
						<Flex justifyContent={'center'}>
							<ButtonGroup spacing="4">
								<Button colorScheme="green" onClick={() => { setCommission(item), setShowModalCommission(true) }}>
									Xem chi tiết
								</Button>
								<Button colorScheme="red" onClick={() => { setDeleteCommissionId(item.id) }}>
									Xóa
								</Button>
							</ButtonGroup>
						</Flex>
				...
				<Modal isOpen={showModalCommission} onClose={() => {
					...
					<ModalContent>
						...
						<ModalBody >
							...
							<FormControl my={4} isInvalid={commission.feeOrder !== null && (commission.feeOrder >= 1 || commission.feeOrder <= 0)}>
							...
							<FormControl my={4}>
								...
								<Input
									...
									min="1"
									onChange={(e) => setCommission({ ...commission, minPoint: parseInt(e.target.value) })}
								/>
							</FormControl>
						</ModalBody>
						<ModalFooter>
