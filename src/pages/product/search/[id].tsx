...
const ProductSearchResult = () => {
	...
	const handleFilterChange = (data) => {
		switch (data.value) {
			case "Date": { setSortTypeState("DEFAULT"); break; }
			case "Price Low to High": { setSortTypeState("PRICE_ASC"); break; }
			case "Price High to Low": { setSortTypeState("PRICE_DESC"); break; }
			case "Relevance": { setSortTypeState("COUNT_SALE_DESC"); break; }
		}
	}
