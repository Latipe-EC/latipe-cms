...
import {
	Box, Button, ButtonGroup, Flex, FormControl, FormErrorMessage, FormLabel, Input,
	Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Spinner, Table, Tbody, Td, Text, Textarea, Th, Thead, Tr, useToast
} from '@chakra-ui/react';
import { ChevronDownIcon, ChevronUpIcon } from '@chakra-ui/icons';
import { Chip } from '../../../components/Chip';
import { Small } from '../../../components/Typography';
import { createDelivery, getAdminListDelivery, upateDelivery, upateStatusDelivery } from '../../../store/slices/deliveries-slice';
import { DeliveryResponse } from 'api/interface/delivery';
						...
						<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
							<Box m="6px">
								<Chip p="0.25rem 1rem" bg={value ? "green" : "red"}>
									<Small textAlign="center" color="white" fontWeight="bold">{value ? "Có" : "Không"}</Small>
								</Chip>
							</Box>
						</div>
					);
							...
							<ModalBody >
								<FormControl id="deliveryName">
									...
									<Input
										...
										min="10"
										onChange={(e) => setSelectDelivery({ ...selectDelivery, delivery_name: e.target.value })}
									/>
								</FormControl>
								...
								<FormControl id="delivery_code">
									...
									<Input
										...
										onChange={(e) => setSelectDelivery({ ...selectDelivery, delivery_code: e.target.value })}
									/>
								</FormControl>
									...
									<>
										<FormControl id="delivery_email" isInvalid={selectDelivery.email !== null &&
											...
											<Input
												...
												onChange={(e) => setSelectDelivery({ ...selectDelivery, email: e.target.value })}
										...
										<FormControl id="delivery_phone" isInvalid={selectDelivery.phone_number !== null &&
											...
											<Input
												...
												onChange={(e) => setSelectDelivery({ ...selectDelivery, phone_number: e.target.value })}
												pattern="^\d{10,11}$"
											/>
											{
												!/^\d{10,11}$/.test(selectDelivery.phone_number) &&
								...
								<FormControl id="base_cost">
									...
									<Input
										...
										type='number'
										min="1"
										onChange={(e) => setSelectDelivery({ ...selectDelivery, base_cost: e.target.value })}
									/>
								</FormControl>
								...
								<FormControl id="description">
									...
									<Textarea
										...
										onChange={(e) => setSelectDelivery({ ...selectDelivery, description: e.target.value })}
										resize="none"
									/>
								</FormControl>
							...
							<ModalFooter>
								<Flex justifyContent="center" alignItems="center" mt={4}>
									...
									<Button
										...
										colorScheme="red" onClick={() => { selectDelivery._id ? handleUpdateDelivery() : handleAddDelivery() }}>
										Lưu
									</Button>
								</Flex>
							</ModalFooter>
