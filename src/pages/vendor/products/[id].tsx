...
import { Options, ProductClassification, ProductResponse, ProductVariant, UpdateProductRequest } from "api/interface/product";
					...
					<AccordionItem >
						...
						<AccordionPanel ml={2} >
							{attributeValues.length > 0 && (
								<AttributeRenderForm attributes={attributeValues} onChange={handleAttributeChange}></AttributeRenderForm>
							)}
						</AccordionPanel>
					</AccordionItem>
					<AccordionItem>
