...
const CategoryForm: React.FC<Props> = ({
	attributes, showModal, selectedCategory, imagePreviewUrl, setShowAddAttribute,
	showAddAttribute, handleAddAttributes, setSelectedCategory,
	setImagePreviewUrl,
				...
				<ModalBody >
					...
					<FormControl  >
						...
						<AttributeForm
							...
							handleAddClose={() => { setShowAddAttribute(false) }}
							handleAddAttributes={handleAddAttributes}
						></AttributeForm>
						<IconButton icon={<EditIcon />} onClick={() => setShowAddAttribute(true)} aria-label={''}></IconButton>
