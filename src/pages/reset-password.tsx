import { Box, Button, FormControl, FormErrorMessage, FormLabel, Heading, Input, Spinner, useToast } from '@chakra-ui/react';
	...
	return (
		<Box width="400px" margin="auto" marginTop="100px">
			<Box mx="auto" my="2rem" p={4} boxShadow="lg" borderRadius="md">
				...
				<FormControl id="confirmPassword" isRequired isInvalid={passwordValidation(confirmPassword)}>
