...
const AttributeForm: React.FC<Props> = ({ attributes, onChange, showAddModal, handleAddClose, removeAttribute, handleAddAttributes }) => {
			...
			<ModalContent>
				...
				<ModalBody >
					<FormControl  >
							...
							{attributes.map((attribute, index) =>
								<>
									<Flex alignItems="center" mb={2} mt={2}>
										...
										<IconButton icon={<SmallCloseIcon />} size="sm" colorScheme="red" onClick={() => removeAttribute(index)} aria-label={""} />
									</Flex>
									<Box>
										...
										{attribute.type === "selectbox" && (
											<>
												...
												<Flex alignItems="center" mb="2">
													...
													<Select id="defaultValue" value={attribute.defaultValue} w="100%" mr="2" onChange={
						...
						<IconButton icon={<AddIcon />} onClick={handleAddAttributes} aria-label={""}></IconButton>
					</FormControl >
				</ModalBody>
				<ModalFooter>
