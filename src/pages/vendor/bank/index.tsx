...
import { withdrawPayPal } from "@stores/slices/payment-slice";
				...
				<Box p={4} bg="white" boxShadow="lg" borderRadius="md">
					...
					<Box my="6px">
						<Chip p="0.5rem 1.5rem" bg="red">
							<Small textAlign="center" color="white" fontWeight="bold" fontSize="lg">Số
								dư: {response.eWallet.toLocaleString('vi-VN')}₫</Small>
						</Chip>
					</Box>
					...
					<FormControl id="withdrawAmount" mb={4} w={"50%"}>
						<FormLabel fontSize="lg" color="blue.700">Nhập số tiền bạn muốn rút từ
							ví</FormLabel>
						<Input
							type="number"
